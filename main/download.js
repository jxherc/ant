...
function listenForDownloadHeaders (ses) {
  ses.webRequest.onHeadersReceived(function (details, callback) {
    ...
    */
    if (details.webContents && (details.webContents.getURL().startsWith('ant://app/pages/pdfViewer') || details.webContents.getURL().startsWith('ant://app/reader/') || details.webContents.getURL() === 'ant://app/index.html')) {
      ...
      callback({
        responseHeaders: {
          ...filteredHeaders,
          'Access-Control-Allow-Origin': 'ant://app',
